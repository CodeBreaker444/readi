...
const Dashboard: React.FC<DashboardProps> = ({ isDark = false }) => {
    ...
    <div className={`p-4 sm:p-6 lg:p-8 ${isDark ? 'text-white' : 'text-gray-900'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 lg:mb-8">
        ...
        <div className={`lg:col-span-2 ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'} rounded-lg shadow-sm border p-4 sm:p-6`}>
          ...
          <div className={`h-64 sm:h-80 rounded-lg flex items-center justify-center ${
            isDark ? 'bg-linear-to-br from-slate-700 to-slate-600' : 'bg-linear-to-br from-blue-50 to-purple-50'
          }`}>
        ...
        <div className={`${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'} rounded-lg shadow-sm border p-4 sm:p-6`}>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3">
            ...
            <select className={`text-sm border rounded-lg px-2 py-1 w-full sm:w-auto ${
              isDark ? 'bg-slate-700 border-slate-600 text-white' : 'bg-white border-gray-300 text-gray-900'
            }`}>
              <option>All</option>
            </select>
          ...
          <div className="flex items-center justify-center h-48">
            <div className="relative">
              <div className={`w-40 h-40 rounded-full border-20 ${
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3">
            ...
            <div className="flex space-x-2">
              <button className={`text-sm px-3 py-1 border rounded-lg ${
                isDark ? 'text-gray-300 border-slate-600 hover:bg-slate-700' : 'text-gray-600 border-gray-300 hover:bg-gray-50'
              }`}>
                Search
              </button>
              <button className={`text-sm px-3 py-1 border rounded-lg ${

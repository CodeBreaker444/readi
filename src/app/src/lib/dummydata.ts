import { Assignment, Checklist, Communication, Document, DocumentType, LUCProcedure, Notifications, OrganizationNode, SafetyIndicator } from '../frontend/src/config/types';

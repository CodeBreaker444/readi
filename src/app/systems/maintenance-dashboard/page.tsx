    ...
    return [
      ...
      },
      {
        ...
        headers: [
          ...
          t('systems.maintenanceDashboard.export.headers.lastMaintenanceBasic'),
          t('systems.maintenanceDashboard.export.headers.lastMaintenanceStandard'),
          t('systems.maintenanceDashboard.export.headers.lastMaintenanceExtraordinary'),
        ...
        rows: data.map((d) => [
          ...
          d.last_maintenance_basic ? new Date(d.last_maintenance_basic).toLocaleDateString('en-GB') : '—',
          d.last_maintenance_standard ? new Date(d.last_maintenance_standard).toLocaleDateString('en-GB') : '—',
          d.last_maintenance_extraordinary ? new Date(d.last_maintenance_extraordinary).toLocaleDateString('en-GB') : '—',

        ...
        <div className="min-h-screen">
            ...
            {showEditSystem && (
                <EditSystemModal open={showEditSystem} toolId={selectedToolId}
                    ...
                    clients={clients} models={models} dFlightEnabled={dFlightEnabled} />
            )}
            ...
            {showEditComponent && (
                <EditComponentModal open={showEditComponent} toolId={selectedToolId}
                    ...
                    models={models} clients={clients} tools={tools} dFlightEnabled={dFlightEnabled} />
            )}

...
interface CalendarEventCreatedEmailProps {
  eventTitle: string;
  eventType: string;
  createdBy: string;
  startDate: string;
...
export const CalendarEventCreatedEmail = ({
  eventTitle,
  eventType,
  createdBy,
  startDate,
  ...
  location,
  description,
}: CalendarEventCreatedEmailProps) => (
  <Html>
    <Head />
    <Tailwind>
      <Body style={main}>
        <Preview>New calendar event — {eventTitle}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Event Created</span>
              </div>

              <Text style={title}>New calendar event added</Text>
              <Text style={paragraph}>
                A new calendar event has been created and added to your schedule.
              </Text>
              ...
              <div style={infoCard}>
                <Text style={infoText}>
                  This event has been added to the calendar and is visible to all relevant team members.
                </Text>
              </div>
...
CalendarEventCreatedEmail.PreviewProps = {
  ...
  description: 'Annual safety and operations training for all pilots.',
} as CalendarEventCreatedEmailProps;

export default CalendarEventCreatedEmail;

...
interface InterventionStartedEmailProps {
  systemCode: string;
  ticketTitle: string;
  ticketId: number;
...
export const InterventionStartedEmail = ({
  ...
  <Html>
    ...
    <Tailwind>
      <Body style={main}>
        <Preview>Maintenance in progress — {systemCode}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Intervention Started</span>
              </div>

              <Text style={title}>Maintenance intervention in progress</Text>
              <Text style={paragraph}>
                Work has begun on the following maintenance ticket.
              </Text>
              ...
              <div style={dataCard}>
                <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={dataRow}>
                  <tbody>
                    ...
                    {startTime && (
                      <tr>
                        <td style={{ ...dataLabel, borderBottom: 'none' }}>START TIME</td>
                        <td style={{ ...dataValue, borderBottom: 'none' }}>{startTime}</td>
                      </tr>
                    )}
                  </tbody>
                </table>
              ...
              <div style={infoCard}>
                <Text style={infoText}>
                  The technician is actively working on this maintenance ticket.
                </Text>
              </div>
...
InterventionStartedEmail.PreviewProps = {
  systemCode: 'DRN-001',
  ticketTitle: 'Motor replacement — System #42',
  ticketId: 123,
  technicianName: 'Jane Doe',
  startTime: '2024-01-15 10:00',
  description: 'Replacing motor and recalibrating sensors.',
} as InterventionStartedEmailProps;

export default InterventionStartedEmail;

...
interface MissionAssignedEmailProps {
  missionCode: string;
  missionType: string;
  assignedBy: string;
  assignedTo: string;
...
export const MissionAssignedEmail = ({
  missionCode,
  missionType,
  assignedBy,
  assignedTo,
  ...
  scheduledDate,
  description,
}: MissionAssignedEmailProps) => (
  <Html>
    <Head />
    <Tailwind>
      <Body style={main}>
        <Preview>Mission assignment — {missionCode}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Mission Assigned</span>
              </div>

              <Text style={title}>You have been assigned to a mission</Text>
              <Text style={paragraph}>
                You have been assigned as {role.toLowerCase()} for mission {missionCode}.
              </Text>
...
MissionAssignedEmail.PreviewProps = {
...
} as MissionAssignedEmailProps;

export default MissionAssignedEmail;

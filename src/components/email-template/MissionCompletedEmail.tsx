...
export const MissionCompletedEmail = ({
  ...
  <Html>
    ...
    <Tailwind>
      <Body style={main}>
        <Preview>Mission completed — {missionCode}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Mission Completed</span>
              </div>

              <Text style={title}>Mission successfully completed</Text>
              <Text style={paragraph}>
                The following mission has been completed and marked as finished.
              </Text>
              ...
              <div style={dataCard}>
                ...
                <div style={dataRowBorder} />
                <div style={dataRow}>
                  <span style={dataLabel}>COMPLETED BY</span>
                  <span style={dataValue}>{completedBy}</span>
                </div>
                <div style={dataRowBorder} />
                <div style={dataRow}>
                  <span style={dataLabel}>COMPLETION TIME</span>
                  <span style={dataValue}>{completionTime}</span>
                </div>
                {duration && (
                  <>
                    <div style={dataRowBorder} />
                    <div style={dataRow}>
                      <span style={dataLabel}>DURATION</span>
                      <span style={dataValue}>{duration}</span>
                    </div>
                  </>
                )}
              </div>
              ...
              {notes && (
                <div style={noteCard}>
                  <Text style={noteTitle}>Completion notes</Text>
              ...
              <div style={infoCard}>
                <Text style={infoText}>
                  Mission data has been logged and is available for review in the operations dashboard.
                </Text>
              </div>
...
MissionCompletedEmail.PreviewProps = {
  missionCode: 'MSSN-2024-001',
  missionType: 'Surveillance',
  completedBy: 'John Smith',
  completionTime: '2024-01-15 14:30',
  duration: '4h 30m',
  notes: 'Mission completed successfully with all objectives met.',
} as MissionCompletedEmailProps;

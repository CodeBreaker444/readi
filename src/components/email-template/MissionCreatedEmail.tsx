...
interface MissionCreatedEmailProps {
  missionCode: string;
  missionType: string;
  createdBy: string;
...
export const MissionCreatedEmail = ({
  missionCode,
  missionType,
  createdBy,
  scheduledDate,
  description,
}: MissionCreatedEmailProps) => (
  <Html>
    <Head />
    <Tailwind>
      <Body style={main}>
        <Preview>New mission created — {missionCode}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Mission Created</span>
              </div>

              <Text style={title}>New mission assigned</Text>
              <Text style={paragraph}>
                A new mission has been created and is now available for assignment.
              </Text>
              ...
              <div style={infoCard}>
                <Text style={infoText}>
                  This mission is now available for pilot assignment and scheduling.
                </Text>
              </div>
...
MissionCreatedEmail.PreviewProps = {
  missionCode: 'MSSN-2024-001',
  missionType: 'Surveillance',
  createdBy: 'John Smith',
  scheduledDate: '2024-01-15 10:00',
  description: 'Routine surveillance mission for sector 7.',
} as MissionCreatedEmailProps;

export default MissionCreatedEmail;

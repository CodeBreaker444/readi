...
export const TicketAssignedEmail = ({
  ...
  <Html>
    ...
    <Tailwind>
      <Body style={main}>
        <Preview>Ticket assigned — {systemCode}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Ticket Assigned</span>
              </div>

              <Text style={title}>Maintenance ticket assigned</Text>
              <Text style={paragraph}>
                A maintenance ticket has been assigned to a technician.
              </Text>
              ...
              <div style={dataCard}>
                <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={dataRow}>
                  <tbody>
                    ...
                    {assignedBy && (
                      <tr>
                        <td style={{ ...dataLabel, borderBottom: 'none' }}>ASSIGNED BY</td>
                        <td style={{ ...dataValue, borderBottom: 'none' }}>{assignedBy}</td>
                      </tr>
                    )}
                  </tbody>
                </table>

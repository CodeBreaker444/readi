...
interface TrainingDeletedEmailProps {
  trainingName: string;
  trainingType?: string | null;
  deletedBy?: string;
}

export const TrainingDeletedEmail = ({
  trainingName,
  trainingType,
  deletedBy,
}: TrainingDeletedEmailProps) => (
  <Html>
    <Head />
    <Tailwind>
      <Body style={main}>
        <Preview>Training record deleted — {trainingName}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Training Deleted</span>
              </div>

              <Text style={title}>Training record removed</Text>
              <Text style={paragraph}>
                The following training record has been permanently removed.
              </Text>
              ...
              <div style={dataCard}>
                <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={dataRow}>
                  <tbody>
                    ...
                    {deletedBy && (
                      <tr>
                        <td style={{ ...dataLabel, borderBottom: 'none' }}>DELETED BY</td>
                        <td style={{ ...dataValue, borderBottom: 'none' }}>{deletedBy}</td>
                      </tr>
                    )}
                  </tbody>
                </table>
              ...
              <Text style={cautionText}>
                If this was not expected, please contact your training manager.
              </Text>
            </Section>
          </Container>
...
TrainingDeletedEmail.PreviewProps = {
  trainingName: 'Recurrent Flight Safety',
  trainingType: 'RECURRENT',
  deletedBy: 'John Smith',
} as TrainingDeletedEmailProps;

export default TrainingDeletedEmail;

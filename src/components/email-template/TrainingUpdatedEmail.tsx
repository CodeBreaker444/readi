...
interface TrainingUpdatedEmailProps {
  trainingName: string;
...
export const TrainingUpdatedEmail = ({
  trainingName,
  trainingType,
  certificateType,
  sessionDate,
  updatedBy,
}: TrainingUpdatedEmailProps) => (
  <Html>
    <Head />
    <Tailwind>
      <Body style={main}>
        <Preview>Training record updated — {trainingName}</Preview>
        ...
        <div style={outer}>
          ...
          <Container style={card}>
            <Section style={section}>
              {/* Status badge */}
              <div style={badgeWrap}>
                <span style={badge}>Training Updated</span>
              </div>

              <Text style={title}>Training record updated</Text>
              <Text style={paragraph}>
                The following training record has been updated.
              </Text>
              ...
              <div style={dataCard}>
                <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={dataRow}>
                  <tbody>
                    ...
                    {updatedBy && (
                      <tr>
                        <td style={{ ...dataLabel, borderBottom: 'none' }}>UPDATED BY</td>
                        <td style={{ ...dataValue, borderBottom: 'none' }}>{updatedBy}</td>
                      </tr>
                    )}
                  </tbody>
                </table>

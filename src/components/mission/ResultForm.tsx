...
export default function ResultForm({ onSubmit, isDark}: ResultFormProps) {
  ...
  <form onSubmit={handleSubmit} className="flex gap-4 items-end">
    ...
    <button
      type="submit"
      className="inline-flex cursor-pointer items-center gap-2 px-6 py-2.5 bg-linear-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg font-medium"
    >
      <Plus size={20} />
      Add Result
    </button>

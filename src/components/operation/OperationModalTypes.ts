...
export interface Drone { tool_id: number; tool_code: string; tool_name: string; in_maintenance?: boolean; maintenance_due?: boolean; is_non_operational?: boolean; is_dismissed?: boolean; drone_serial_number?: string | null }
...
export interface MissionPlanningOption { mission_planning_id: number; mission_planning_code: string; mission_planning_desc: string; mission_planning_active: string; fk_planning_id: number; tool_code: string }
